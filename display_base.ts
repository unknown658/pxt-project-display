...
namespace OLED_Display {
    ...
    // x is the X axis value, eg: 0
    // y is the Y axis value, eg: 0
    // screen is screen selection when using multiple screens
    ...
    // displayShowAlign is the alignment of the text, this can be left, centre or right
    // line is line the text to be started on, eg: 1
    // inputData is the text will be show
    // screen is screen selection when using multiple screens
    ...
    // lineDirection is the selection of either horizontal line or vertical line
    // x is start position on the X axis, eg: 0
    // y is start position on the Y axis, eg: 0
    // len is the length of line, length is the number of pixels, eg: 10
    // screen is screen selection when using multiple screens
    ...
    // width is width of the rectangle, eg: 60
    // height is height of the rectangle, eg: 30
    // x is the start position on the X axis, eg: 0
    // y is the start position on the Y axis, eg: 0
    // screen is screen selection when using multiple screens
    ...
    // displayOutput is the boolean setting for the screen, either ON or OFF
    // screen is screen selection when using multiple screens
    ...
    // plotVariable is the variable to be recorded on a graph on the display
    // screen is screen selection when using multiple screens
    ...
    // output toggles between inverting the colours of the display
